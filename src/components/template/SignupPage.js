...
function SignupPage() {
    ...
    return (
        <div className="min-w-screen min-h-screen font-DanaMedium bg-white flex items-center justify-center px-5 ">
            <div className=" text-gray-500 rounded-3xl  w-full overflow-hidden md:max-w-[1200px] p-10" >
                <div className="md:flex w-full">
                    <div className="hidden md:block rounded w-1/2 bg-indigo-500 py-10 px-10">
                        <svg id="a87032b8-5b37-4b7e-a4d9-4dbfbe394641"
                            ...
                            <polygon points="636.98 735.021 624.72 735.021 618.888 687.733 636.982 687.734 636.98 735.021"
                                fill="#ffb8b8" />
                            <path d="M615.96281,731.51778h23.64387a0,0,0,0,1,0,0v14.88687a0,0,0,0,1,0,0H601.076a0,0,0,0,1,0,0v0A14.88686,14.88686,0,0,1,615.96281,731.51778Z"
                                fill="#2f2e41" />
                    ...
                    <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                        <div className="text-center mb-10">
                            ...
                            <span className='m-1'>یا</span>
                            <Link href="/signin" className='text-xl text-blue-600'>ورود</Link>
                        </div>
                        <div>
                            <div className="flex  -mx-3 p-2 ">
                                <div className="w-1/2 -px-3 mb-5 ">
                                    ...
                                    <div className="flex">
                                        <div className=" z-10 pl-1 text-center pointer-events-none flex items-center justify-right">
                            ...
                            <div className="flex -mx-3 ">
                                <div className="w-full px-3 mb-5">
                                    ...
                                    <div className="flex">
                                        <div className=" z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                                        <input
                            ...
                            <div className="flex -mx-3 ">
                                <div className="w-full px-3 mb-5">
                                    ...
                                    <div className="flex">
                                        <div className=" z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                                        <input
                                        ...
                                        loading ?
                                            (
                                                ...
                                                <button
                                                    ...
                                                    className="mt-12 block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">
                                                    ثبت نام
                                                </button>
                                            )
                                    }
